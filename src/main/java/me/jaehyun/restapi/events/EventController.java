...
import me.jaehyun.restapi.accounts.AccountAdapter;
import me.jaehyun.restapi.accounts.CurrentUser;
...
public class EventController {
    ...
    @PostMapping()
    public ResponseEntity createEvent(@RequestBody @Valid EventDto eventDto, Errors errors, @CurrentUser Account currenUser) {
        if (errors.hasErrors()) {
    ...
    @GetMapping
    public ResponseEntity quetyEvents(Pageable pageable
